            ...
            while( $classic_ecommerce_queryvar->have_posts() ) : $classic_ecommerce_queryvar->the_post(); ?>
              <div class="slidesection"> 
                <?php if(has_post_thumbnail()){
                  ...
                  <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/slider.png" alt="<?php echo esc_attr( 'slider', 'classic-ecommerce'); ?>"/>
                <?php } ?>
                <div class="slider-box">
                  <h1><a href="<?php echo esc_url( get_permalink() );?>"><?php the_title(); ?></a></h1>
                  <?php
                    $classic_ecommerce_trimexcerpt = get_the_excerpt();
                    $classic_ecommerce_shortexcerpt = wp_trim_words( $classic_ecommerce_trimexcerpt, $classic_ecommerce_num_words = 20 );
                    echo '<p>' . esc_html( $classic_ecommerce_shortexcerpt ) . '</p>'; 
                  ?>
                  <div class="shop-now">
                    <?php 
